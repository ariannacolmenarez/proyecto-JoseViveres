...
$.ajax({
    ...
    if(resp!=0){
        switch(periodo['tipoPeriodo']){
            ...
            break;
            case 'mensual':
                divMensual.innerHTML='<center><button class="btn btn-outline-success" type="button" onclick="generarReporte(2)">Imprimir</button></center><br>';
